...
export const SignIn: React.FC = () => {
  ...
  const [showAnnouncementCard, setShowAnnouncementCard] = useState(true);
  ...
  React.useEffect(() => {
    const fetchAnnouncement = async () => {
      try {
        ...
        if (settings.showAnnouncement && settings.announcementTitle && settings.announcementContent) {
          setAnnouncement({
            title: settings.announcementTitle,
            content: settings.announcementContent,
          });
        }
      } catch (error) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Announcement Card */}
        {announcement && showAnnouncementCard && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <AnnouncementCard
              ...
              onDismiss={() => setShowAnnouncementCard(false)}
            />
          </motion.div>
        )}
