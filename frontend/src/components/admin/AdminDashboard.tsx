                              ...
                              <div className="relative flex items-center justify-center">
                                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                  <Button
                                    ...
                                    className={`${selectedUser === profile.userId
                      ...
                      {filteredLeaderboard.map((entry, index) => {
                        ...
                        return (
                          <motion.tr
                            ...
                            className={`hover:bg-game-teal-50/50 transition-colors ${index < 3 ? 'bg-gradient-to-r from-game-teal-50/20 via-game-orange-50/20 to-game-purple-50/20' : ''
                              }`}
                          >
                            <td className="px-4 py-3">
                              {index < 3 ? (
